...
from adf_utils.config import credit
...
def dnn_fair_testing(dataset, sens_params, model_path):
    ...
    data = {"credit":credit_data}
           
    data_config = {"credit":credit}
...
if __name__ == '__main__':
    ...
    flags.DEFINE_list('sens_params',[13,9],'sensitive parameters index.1 for age, 9 for gender, 8 for race')
    tf.app.run()
